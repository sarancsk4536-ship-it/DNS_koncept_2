(() => {
  ...
  const POPULARITY = window.CATEGORY_POPULARITY_V61 || window.CATEGORY_POPULARITY_V60 || window.CATEGORY_POPULARITY_V59 || { sourceRows: [], aliases: {}, aggregates: {}, matchesById: {} };
