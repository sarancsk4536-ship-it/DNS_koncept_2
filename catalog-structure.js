(() => {
  ...
  const macroSections = [
    { id: "power-tools", name: "Электроинструмент", order: 10, image: "assets/type-01-power-tools.webp" },
    { id: "accessories", name: "Оснастка, расходные материалы и аксессуары", order: 20, image: "assets/type-03-accessories.webp" },
    { id: "hand-tools", name: "Ручной инструмент", order: 30, image: "assets/type-02-hand-tools.webp" },
    { id: "power-equipment", name: "Строительная и силовая техника", order: 40, image: "assets/type-04-power-equipment.webp" },
    { id: "measuring", name: "Измерительный и диагностический инструмент", order: 50, image: "assets/type-06-measuring.webp" },
    { id: "welding", name: "Сварочное и паяльное оборудование", order: 60, image: "assets/type-07-welding.webp" },
    { id: "pneumatics", name: "Пневмоинструмент и компрессорное оборудование", order: 70, image: "assets/type-04-power-equipment.webp" },
    { id: "cleaning", name: "Клининговое оборудование", order: 80, image: "assets/type-08-storage.webp" },
    { id: "storage-ppe-root", name: "Средства индивидуальной защиты и хранение инструмента", order: 90, image: "assets/type-08-storage.webp" },
    { id: "workshop", name: "Станки и оборудование для мастерской", order: 100, image: "assets/type-08-storage.webp" },
  ];
  ...
  const groups = [
    ...
    },
    {
      ...
      name: "Ключи",
      categories: ["Наборы ключей", "Ключи разводные", "Ключи трубные", "Шестигранные ключи", "Динамометрические ключи"],
    },
    {
    ...
    },
    {
      ...
      categories: ["Зубила и кернеры", "Кувалды", "Кирки", "Ломы, монтировки и гвоздодеры", "Молотки и киянки", "Топоры и колуны", "Лопаты"],
    },
    {
      id: "cutting-hand-tools", macroId: "hand-tools", order: 50,
      name: "Режущий инструмент",
      categories: ["Мультифункциональные ножи", "Ножи монтерские", "Пилы и ножовки", "Ножовки по дереву", "Ножовки по металлу", "Ножовочные полотна", "Ножницы по металлу", "Ножницы канцелярские", "Ножницы строительные", "Ножеточки", "Стамеска, долото и рубанок", "Строительные ножи", "Труборезы", "Болторезы", "Плиткорезы ручные"],
    },
    {
      id: "tool-sets", macroId: "hand-tools", order: 60,
      name: "Наборы ручного инструмента",
      categories: ["Наборы автоинструмента", "Наборы столярно-слесарного инструмента", "Наборы ключей", "Наборы отверток", "Наборы шарнирно-губцевого инструмента", "Наборы торцевых головок", "Мультитулы"],
    },
    {
      id: "pliers-tools", macroId: "hand-tools", order: 70,
      name: "Шарнирно-губцевые инструменты",
      categories: ["Бокорезы и кусачки", "Клещи и специализированный ручной инструмент", "Многофункциональные и стандартные пассатижи", "Мультитул", "Ножницы и болторезы", "Болторезы", "Ножницы по металлу", "Просекатели", "Ручные заклепочники", "Плоскогубцы, тонкогубцы", "Клещи зажимные", "Пружинные зажимы", "Пинцеты", "Ремни стяжные"],
    },
    {
    ...
    },
    {
      ...
      categories: ["Струбцины", "Тиски", "Клещи зажимные", "Пружинные зажимы", "Пинцеты", "Ремни стяжные"],
    },
    {
    ...
    {
      id: "safety-ppe", macroId: "hand-tools", order: 120,
      name: "СИЗ и защита",
      categories: ["Защита органов зрения", "Перчатки", "Защита органов слуха", "Респираторы", "Спецодежда"],
    },
  ...
  const navigationSections = [
    {
      ...
      groups: [
        ...
        { id: "nav-mixing", name: "Смешивание", categoryIds: [...fromGroups(["mixing-power-tools", "mixing-accessories"])] },
        {
          ...
          subgroups: [
            { id: "steel", name: "Резка стали", categoryIds: hardMaterialSteelIds },
            { id: "concrete", name: "Резка бетона", categoryIds: hardMaterialConcreteIds },
            { id: "tile", name: "Резка плитки", categoryIds: hardMaterialTileIds },
          ],
        },
    ...
    },
    {
      ...
      groups: [
        ...
        { id: "nav-impact-demolition", name: "Ударно-рычажный инструмент", categoryIds: fromGroups(["striking-prying-tools"]) },
        { id: "nav-cutting-hand", name: "Режущий и столярно-слесарный инструмент", categoryIds: fromGroups(["cutting-hand-tools"]) },
        ...
        { id: "nav-tool-sets", name: "Наборы ручного инструмента", categoryIds: fromGroups(["tool-sets"]) },
        { id: "nav-electrical-installation", name: "Электромонтажный инструмент", categoryIds: fromGroups(["electrical-hand-tools"]) },
      ],
    },
    {
    ...
    {
      id: "nav-power-equipment", name: "Строительная и силовая техника", order: 40, image: "assets/type-04-power-equipment.webp",
      groups: [
    ...
    },
    {
      ...
      groups: [
        { id: "nav-linear-measuring", name: "Линейные измерения", categoryIds: pick(["Рулетки, линейки и измерительные ленты", "Микрометры", "Курвиметры"]) },
        { id: "nav-angular-measuring", name: "Угловые измерения", categoryIds: pick(["Уровни и отвесы", "Угольники, транспортиры и малки"]) },
        ...
        { id: "nav-electrical-measuring", name: "Электроизмерительные приборы", categoryIds: pick(["Измерители параметров эл.сетей"]) },
        { id: "nav-technical-control", name: "Температурные измерения", categoryIds: pick(["Пирометры и лазерные термометры", "Тепловизоры"]) },
        { id: "nav-physical-measuring", name: "Физические параметры", categoryIds: pick(["Точные весы", "Механические штангенциркули", "Электронные штангенциркули"]) },
      ],
    },
    {
    ...
    {
      id: "nav-storage-safety", name: "Хранение и организация рабочего места", order: 80, image: "assets/type-08-storage.webp",
      groups: [
    ...
    {
      id: "nav-ppe", name: "СИЗ и защита", order: 90, image: "assets/type-08-storage.webp",
      groups: [
        { id: "nav-ppe-items", name: "Средства индивидуальной защиты", categoryIds: pick(["Защита органов зрения", "Перчатки", "Защита органов слуха", "Респираторы", "Спецодежда"]) },
      ],
    },
  ];
  ...
  const subgroupDefinitions = {
    ...
    "nav-pliers-clamping": [
      ...
      { id: "multi-sets", name: "Мультитулы", categoryIds: pick(["Мультитул"]) },
