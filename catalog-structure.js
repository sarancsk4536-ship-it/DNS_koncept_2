(() => {
  ...
  const groups = [
    ...
    },
    {
      ...
      name: "СИЗ и защита",
      categories: ["Очки защитные", "Перчатки", "Наушники защитные", "Респираторы", "Спецодежда"],
    },
  ...
  const navigationSections = [
    ...
    },
    {
      ...
      groups: [
        { id: "nav-ppe-items", name: "Средства индивидуальной защиты", categoryIds: pick(["Очки защитные", "Перчатки", "Наушники защитные", "Респираторы", "Спецодежда"]) },
      ],
    },
  ];
