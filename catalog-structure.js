(() => {
  ...
  const groups = [
    ...
    },
    {
      ...
      categories: ["Дрель", "Дрель-миксер", "Отбойный молоток", "Перфоратор аккумуляторный", "Перфоратор сетевой"],
    },
    {
      id: "cutting-power-tools", macroId: "power-tools", order: 30,
      name: "Отрезной электроинструмент",
      categories: ["Гравировальные машинки", "Реноватор", "УШМ (Шлифмашина Угловая) Аккумуляторная", "УШМ (Шлифмашина Угловая) Сетевая", "Штроборез"],
    },
    {
    ...
    },
    {
      ...
      categories: ["Полировальная машина", "Прямошлифовальная машина", "Шлифмашина Вибрационная", "Шлифмашина Ленточная", "Шлифмашина по бетону", "Шлифмашина Эксцентриковая", "Щеточная шлифмашина"],
    },
    {
    ...
    },
    {
      ...
      name: "Аксессуары",
      categories: ["Магнитные держатели для бит", "Миксеры для строительных смесей", "Пылеулавливающий кожух", "Шаблоны для сверления и бурения"],
    },
  ...
  const navigationSections = [
    ...
    },
    {
      ...
      groups: [
        { id: "nav-drilling-demolition-accessories", name: "Для сверления, смешивания, бурения и разрушения", categoryIds: [...fromGroups(["drilling-accessories", "demolition-accessories"]), ...pick(["Набор коронок", "Набор сверл", "Наборы буров и зубил", "Наборы сверл и оснастки", "Шаблоны для сверления и бурения", "Миксеры для строительных смесей"])] },
  ...
  const subgroupDefinitions = {
    ...
    "nav-sawing-cutting": [
      { id: "cutting-universal", name: "Резка, штробление и универсальная обработка", categoryIds: fromGroups(["cutting-power-tools"]) },
    ...
    "nav-drilling-demolition-accessories": [
      { id: "drilling", name: "Для сверления и смешивания", categoryIds: pick(["Коронки (перфоратор, УШМ, дрель)", "Набор коронок", "Сверла по бетону и камню", "Сверла по дереву (спиральные, перьевые,Форстнера)", "Сверла по металлу", "Сверла по стеклу и плитке", "Ступенчатые сверла", "Набор сверл", "Наборы сверл и оснастки", "Шаблоны для сверления и бурения", "Миксеры для строительных смесей"]) },
  ...
  window.MANAGEMENT_TAXONOMY_V6 = { version: 11, macroSections, groups, navigationSections, virtualCategories };
})();
