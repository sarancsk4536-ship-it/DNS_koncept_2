(() => {
  ...
  const popularGroups = [
    ...
    {
      title: "Строительная и силовая техника",
      route: "N0329",
      links: [
        ["Электрогенераторы", "https://www.dns-shop.ru/catalog/17a9d22a16404e77/elektrogeneratory/"],
        ["Бетоносмесители", "https://www.dns-shop.ru/catalog/be249f27bebe7fd7/betonosmesiteli/"],
  ...
  root.innerHTML = `
    <div class="site-frame">
      ...
      <main class="page-shell">
        <nav class="breadcrumbs" aria-label="Навигация"><button type="button" data-bootstrap-kind="home">Каталог</button><i>›</i><span>Ремонт и строительство</span></nav>
        <section class="page-intro"><h1>Ремонт и строительство</h1></section>
        <section class="entry-grid">
          ${entryCard("stages", "Подбор по этапам работ", "assets/generated/stages/selection-by-work-stages.webp")}
          ${entryCard("types", "По типу инструмента", "assets/generated/phase-01/entry-03-tool-types.webp")}
          ${entryCard("platforms", "Аккумуляторные платформы", "assets/generated/phase-01/entry-01-accumulator-platforms.webp")}
        </section>
  ...
  function loadApplication() {
    ...
    appPromise = Promise.all([
      ...
      loadScript("work-stages.js"),
      loadScript("category-popularity.js"),
    ])
